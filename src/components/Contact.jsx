                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="contact-info-item flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:developerdrogo06@gmail.com" className="text-white font-medium hover:text-purple-400 transition-colors">
                            ...
                            <div className="space-y-6">
                                ...
                                <a
                                    ...
                                    className="social-link flex items-center space-x-4 glass-dark rounded-xl p-4 hover:scale-105 transition-transform"
                                >
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400 text-sm">Watch tutorials</p>
                                    </div>
                                </a>
                            </div>
                        </div>
